...
export default {
    ...
    methods: {
      ...
      getdata(){
        ...
        this.$http( this.$url.url_http + '/buildQuality/queryById',{body},{},{},'post').then(function(res){
            ...
            if(res.data.code==0){
                ...
                _this.baseExcavationPercentage = _this.is_type_styte(res.data.response.baseExcavationPercentage);
                    ...
                    for (let img in res.data.response.buildQualityPicsList){
                        _this.preImgSrcList[img].preImgSrc = res.data.response.buildQualityPicsList[img].picUrl;
                    }
